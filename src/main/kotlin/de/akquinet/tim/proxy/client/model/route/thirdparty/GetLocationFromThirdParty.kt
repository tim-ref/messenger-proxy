...
/**
 * @see <a
 *   href="https://spec.matrix.org/v1.3/client-server-api/#get_matrixclientv3thirdpartylocationprotocol">matrix
 *   spec</a>
 */
@Serializable
...
data class GetLocationFromThirdParty(@SerialName("protocol") val protocol: String) :
