...
/**
 * @see <a
 *   href="https://spec.matrix.org/v1.3/server-server-api/#put_matrixfederationv1send_joinroomideventid">matrix
 *   spec</a>
 */
@Serializable
...
data class SendJoinV1(
  ...
  MatrixEndpoint<
    Signed<PersistentDataUnit.PersistentStateDataUnit<MemberEventContent>, String>,
    SendJoinV1.Response,
  > {
  ...
  override fun requestSerializerBuilder(
    ...
    val serializer =
      requireNotNull(
        json.serializersModule.getContextual(PersistentDataUnit.PersistentStateDataUnit::class)
      )
  ...
  data class Response(
    ...
    @SerialName("event")
    val event:
      Signed<@Contextual PersistentDataUnit.PersistentStateDataUnit<MemberEventContent>, String>? =
      null,
    @SerialName("origin") val origin: String,
    @SerialName("state") val state: List<SignedPersistentStateDataUnit<*>>,
  )
}
